...
namespace Microsoft.Bot.Sample.QnABot
{
    ...
    public class BasicQnAMakerPreviewDialog : QnAMakerDialog
    {
        ...
        public BasicQnAMakerPreviewDialog() : base(new QnAMakerService(new QnAMakerAttribute(RootDialog.GetSetting("QnAAuthKey"), Utils.GetAppSetting("QnAKnowledgebaseId"), "মামা কিছু পাই নাই, অন্য কিছু জিগান বলে দিচ্ছি :D", 0.25)))
        { }
    }
